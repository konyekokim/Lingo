...
public class ChooseLanguageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nigerianLayout = (RelativeLayout) findViewById(R.id.nigerian_layout);
        yorubaLayout = (RelativeLayout) findViewById(R.id.yoruba_layout);
        igboLayout = (RelativeLayout) findViewById(R.id.igbo_layout);
        hausaLayout = (RelativeLayout) findViewById(R.id.hausa_layout);
        efikLayout = (RelativeLayout) findViewById(R.id.efik_layout);
        storeButton = (ImageView) findViewById(R.id.store_button);
