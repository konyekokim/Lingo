...
public class LanguageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBarTextView.setText("Stage 1");
        TextView progressTextView = (TextView) findViewById(R.id.app_text_view);
        progressTextView.setText("Your English Progress");
        RoundCornerProgressBar langProgressBar = (RoundCornerProgressBar) findViewById(R.id.lang_progress_bar);
        ...
        final ViewPager viewPager = (ViewPager) findViewById(R.id.slide_video_pager);
