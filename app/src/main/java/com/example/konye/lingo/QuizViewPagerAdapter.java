...
public class QuizViewPagerAdapter extends PagerAdapter {
    ...
    ImageView imgAns1, imgAns2, imgAns3, imgAns4,ans1,ans2, ans3, ans4;
    TextView quizViewTitle, questionItem1, questionItem2;
    int quizPosition;
    String quizNum;
   // ArrayList<QuizType2> quizType2list;
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        quizViewTitle = (TextView) quizItemView.findViewById(R.id.quiz_view_title);
        questionItem1 = (TextView) quizItemView.findViewById(R.id.quiz_view_question);
        imgAns1 = (ImageView) quizItemView.findViewById(R.id.img_ans_1);
        imgAns2 = (ImageView) quizItemView.findViewById(R.id.img_ans_2);
        imgAns3 = (ImageView) quizItemView.findViewById(R.id.img_ans_3);
        imgAns4 = (ImageView) quizItemView.findViewById(R.id.img_ans_4);
        ...
        imgAns1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ans1 = (ImageView) quizItemView.findViewById(R.id.ans1);
                ans2 = (ImageView) quizItemView.findViewById(R.id.ans2);
                ans3 = (ImageView) quizItemView.findViewById(R.id.ans3);
                ans4 = (ImageView) quizItemView.findViewById(R.id.ans4);
        ...
        ((ViewPager)container).addView(quizItemView);
