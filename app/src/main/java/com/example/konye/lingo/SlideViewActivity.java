...
public class SlideViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBarTextView.setText("Slides");
        ...
        prevButton = (ImageView) findViewById(R.id.slides_view_prev_butn);
        numPageButton = (TextView) findViewById(R.id.slides_view_num_page);
        nextButton = (ImageView) findViewById(R.id.slides_view_next_butn);
        numPageButton.setText(currentPageAsString+"/"+totalNumOfPagesAsString);
        prevButton.setVisibility(View.GONE);

        viewPager = (ViewPager) findViewById(R.id.slides_view_pager);
