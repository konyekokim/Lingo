...
public class WeekBestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final ImageView firstImgView = (ImageView) weekBestView.findViewById(R.id.best_week_first_img);
        final ImageView secondImgView = (ImageView) weekBestView.findViewById(R.id.best_week_second_img);
        ImageView thirdImgView = (ImageView) weekBestView.findViewById(R.id.best_week_third_img);
